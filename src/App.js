...
function getQuestion(i) {
  term = francais[Math.floor(Math.random() * francais.length)];
...
function getAudio() {
  ...
  return [
    ...
    new Audio(`francais/voices/Audrey/${word}.mp3`),
    new Audio(`francais/voices/Aurelie/${word}.mp3`),
    new Audio(`francais/voices/Chantal/${word}.mp3`),
    new Audio(`francais/voices/Nicolas/${word}.mp3`),
    new Audio(`francais/voices/Thomas/${word}.mp3`),
  ];
}
